...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-32 px-6 md:px-12 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div ref={textRef} className="space-y-6 text-xl text-gray-700 leading-relaxed">
              <p>
              ...
              <motion.div className="flex gap-4 pt-6">
                <motion.div
                  ...
                  className="px-6 py-4 bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-100 relative overflow-hidden group"
                >
                  <motion.div
                  ...
                  />
                  <span className="text-3xl font-light block">8+</span>
                  <p className="text-sm text-gray-600">Years Experience</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05, y: -5 }}
                  className="px-6 py-4 bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 relative overflow-hidden group"
                >
                  <motion.div
